...
$query = "INSERT INTO students (firstName, lastName, requestTime, endTime) VALUES('Justin','Gruen', '12:55PM', '1:30AM')";
$result = $link->query($query);
if(!$result) {
  echo "<br> bad query <br>";
}
...
$query = "INSERT INTO students (firstName, lastName, requestTime, endTime) VALUES('Julia','Cunningham', '4:00PM', '5:00PM')";
$result = $link->query($query);
if(!$result) {
  echo "<br> bad query <br>";
}
...
$query = "INSERT INTO MPC1 (firstName, lastName, requestTime, endTime) VALUES('Justin','Gruen', '3:55PM', '4:30PM')";
$result = $link->query($query);
if(!$result) {
  echo "<br> bad query <br>";
}
...
$query = "INSERT INTO MPC1 (firstName, lastName, requestTime, endTime) VALUES('Julia','Cunningham', '2:45PM', '4:00PM')";
$result = $link->query($query);
if(!$result) {
  echo "<br> bad query <br>";
}
...
$query = "INSERT INTO MPC2 (firstName, lastName, requestTime, endTime) VALUES('Justin','Gruen', '3:55PM', '4:30PM')";
$result = $link->query($query);
if(!$result) {
  echo "<br> bad query <br>";
}
...
$query = "INSERT INTO MPC2 (firstName, lastName, requestTime, endTime) VALUES('Julia','Cunningham', '2:45PM', '4:00PM')";
$result = $link->query($query);
if(!$result) {
  echo "<br> bad query <br>";
}
 ...
 $query = "INSERT INTO SoundStudio (firstName, lastName, requestTime, endTime) VALUES('Justin','Gruen', '3:55PM', '4:30PM')";
 $result = $link->query($query);
 if(!$result) {
   echo "<br> bad query <br>";
 }
 ...
 $query = "INSERT INTO SoundStudio (firstName, lastName, requestTime, endTime) VALUES('Julia','Cunningham', '2:45PM', '4:00PM')";
 $result = $link->query($query);
 if(!$result) {
   echo "<br> bad query <br>";
 }
